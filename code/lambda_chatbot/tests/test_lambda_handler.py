...
def test_good_request(good_request_event):
    ...
    assert response['dialogAction']['message']['content'] == 'Sure, here is the list of movements: [Operation #909828eb]  Item: Noise Cancelling Headphones - Qty: 12 - Destination: c.'
